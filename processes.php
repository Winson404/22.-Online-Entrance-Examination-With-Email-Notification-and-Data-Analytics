	...
	if(isset($_POST['create_examinee'])) {
		...
		if(mysqli_num_rows($check_username)>0) {
		  ...
		  header("Location: register.php");
			...
			if($age_num <= 12) {
				$_SESSION['message']  = "Birthday should be earlier than 2011.";
			    $_SESSION['text'] = "Please try again.";
			    $_SESSION['status'] = "error";
				header("Location: register.php");
			} else {
			    ...
			    // if everything is ok, try to upload file
		    		...
		    		if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $sign_target_file)) {
				          ...
				          $message = '<p>Good day sir/maam <b>'.$firstname.' '.$middlename.' '.$lastname.' '.$suffix.'</b>, this is to inform you that you have successfully registered to the system, BCS Entrance Examination  using your email.</p>
