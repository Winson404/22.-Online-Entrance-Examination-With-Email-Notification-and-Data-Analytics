<title>BCS Entrance Examination  | Examinee account mgmt.</title>
                      ...
                      ?>
                        ...
                        <td>
                          <?php if($row['receiptImage_Status'] == 0): ?>
                            <span class="badge bg-danger pt-1">Unverified</span>
                          <?php else: ?>
                            <span class="badge bg-success pt-1">Verified</span>
                          <?php endif; ?>
                        </td> 
                        <td>
