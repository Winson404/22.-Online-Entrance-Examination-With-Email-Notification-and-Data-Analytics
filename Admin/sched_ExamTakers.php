<title>BCS Entrance Examination  | Schedule mgmt.</title>
                    ...
                    <tr>
                      ...
                      ?>
                        ...
                        <td>
                          ...
                          <?php else: ?>
                            <button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#confirm<?php echo $row['bookingsId']; ?>" disabled><i class="fa-solid fa-circle-check"></i></button>
                          <?php endif; ?>
                        </td> 
                    </tr>
