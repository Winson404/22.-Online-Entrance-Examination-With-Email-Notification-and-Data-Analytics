...
if(isset($_POST['update_category'])) {
	...
	// CONFIRM RECEIPT IMAGE - EXAMINEE_DELETE.PHP
	if(isset($_POST['confirm_reciept'])) {
		$user_Id = $_POST['user_Id'];

		$confirm = mysqli_query($conn, "UPDATE users SET receiptImage_Status=1 WHERE user_Id='$user_Id' ");
		 if($confirm) {
	      	$_SESSION['message'] = "Reciept image has been verified";
	        $_SESSION['text'] = "Confirmation successful!";
	        $_SESSION['status'] = "success";
			header("Location: examinee.php");
	      } else {
	        $_SESSION['message'] = "Something went wrong while confirming receipt.";
	        $_SESSION['text'] = "Please try again.";
	        $_SESSION['status'] = "error";
			header("Location: examinee.php");
	      }
