...
<head>
  ...
  <title>BCS Entrance Examination </title>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="../images/logo_final.png" alt="BMSLogo" height="105" width="105">
  </div> 
...
?>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="profile.php" class="brand-link">
      <img src="../images/logo_final.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">BCS Entrance Examination </span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-3">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <?php 
              $mybooked = mysqli_query($conn, "SELECT * FROM exam_bookings JOIN schedule ON exam_bookings.bookingsSchedID=schedule.schedID WHERE bookingsUserId='$id' AND bookingsStatus='Confirmed'");
              if(mysqli_num_rows($mybooked) > 0) {
                $aa = mysqli_fetch_array($mybooked);
            ?>
              <a href="exam.php?user_Id=<?php echo $id; ?>" class="nav-link"><i class="fa-solid fa-file-pen"></i><p>&nbsp; Take examination</p></a>
            <?php } else { ?>
              <a href="#" class="nav-link" data-toggle="modal" data-target="#book"><i class="fa-solid fa-file-pen"></i><p>&nbsp; Take examination</p></a>
            <?php } ?>
          </li>
          <li class="nav-item">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
       <div class="modal-header bg-light">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-calendar-days"></i> Booking examination</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true"><i class="fa-solid fa-circle-xmark"></i></span>
        </button>
      </div>
      <div class="modal-body">
          <h6 class="text-center">You should have booked a schedule first before you can take the exam.</h6>
      </div>
