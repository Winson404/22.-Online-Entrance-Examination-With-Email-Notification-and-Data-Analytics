              ...
              ?>
                    <div class="container"id="printElement">
                      ...
                      <div class="col-12 p-3">
                        <p><?php echo ' '.$row['firstname'].' '.$row['middlename'].' '.$row['lastname'].' '.$row['suffix'].' '; ?> have <?php if($passfail >= 50) { echo '<b>Passed</b>'; } else { echo '<b>SAMPLE REMARK</b>'; } ?> the Entrance Examination with a score of <b><?php echo $count; ?>%</b> out of 100 items.</p>
                        <hr>
                      </div>
