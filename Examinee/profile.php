<title>BCS Entrance Examination  | Examinee profile</title>
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item"><a class="nav-link" href="#receipt" data-toggle="tab">Reciept info</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="receipt">
                      ...
                      <div class="form-group">
                        <div class="col-sm-12">
                          <img src="../images-receipt/<?php echo $row['receiptImage']; ?>" alt="" class="img-fluid d-block m-auto">
                        </div>
                      </div>
                      <div class="form-group text-center">
                          <?php if ($row['receiptImage_Status'] == 0): ?>
                            <span class="badge badge-danger pt-1">Unverified</span>
                          <?php else: ?>
                            <span class="badge badge-success pt-1">Verified</span>
                          <?php endif; ?>
                      </div>
                  </div>
