<!-- One "tab" for each step in the form: -->
                    <div class="tab">
                      ...
                      <?php
                        $fetch = mysqli_query($conn, "SELECT * FROM questions JOIN category ON questions.quest_category_Id=category.cat_Id WHERE cat_name='English' LIMIT 5, 1");
                        if(mysqli_num_rows($fetch) > 0) {
                        $row = mysqli_fetch_array($fetch);
                      ?>
                      ...
                      <?php
                        $fetch = mysqli_query($conn, "SELECT * FROM questions JOIN category ON questions.quest_category_Id=category.cat_Id WHERE cat_name='English' LIMIT 6, 1");
                        if(mysqli_num_rows($fetch) > 0) {
                        $row = mysqli_fetch_array($fetch);
                      ?>
                      ...
                      <?php
                        $fetch = mysqli_query($conn, "SELECT * FROM questions JOIN category ON questions.quest_category_Id=category.cat_Id WHERE cat_name='English' LIMIT 7, 1");
                        if(mysqli_num_rows($fetch) > 0) {
                        $row = mysqli_fetch_array($fetch);
                      ?>
                      ...
                      <?php } ?>
                       ...
                       <?php
                        $fetch = mysqli_query($conn, "SELECT * FROM questions JOIN category ON questions.quest_category_Id=category.cat_Id WHERE cat_name='English' LIMIT 8, 1");
                        if(mysqli_num_rows($fetch) > 0) {
                        $row = mysqli_fetch_array($fetch);
                      ?>
                      ...
                      <?php
                        $fetch = mysqli_query($conn, "SELECT * FROM questions JOIN category ON questions.quest_category_Id=category.cat_Id WHERE cat_name='English' LIMIT 9, 1");
                        if(mysqli_num_rows($fetch) > 0) {
                        $row = mysqli_fetch_array($fetch);
                      ?>
                      ...
                      <?php
                        $fetch = mysqli_query($conn, "SELECT * FROM questions JOIN category ON questions.quest_category_Id=category.cat_Id WHERE cat_name='English' LIMIT 10, 1");
                        if(mysqli_num_rows($fetch) > 0) {
                        $row = mysqli_fetch_array($fetch);
                      ?>
                      ...
                      <?php
                        $fetch = mysqli_query($conn, "SELECT * FROM questions JOIN category ON questions.quest_category_Id=category.cat_Id WHERE cat_name='English' LIMIT 11, 1");
                        if(mysqli_num_rows($fetch) > 0) {
                        $row = mysqli_fetch_array($fetch);
                      ?>
                      ...
                      <?php } ?>
                       ...
                       <?php
                        $fetch = mysqli_query($conn, "SELECT * FROM questions JOIN category ON questions.quest_category_Id=category.cat_Id WHERE cat_name='English' LIMIT 12, 1");
                        if(mysqli_num_rows($fetch) > 0) {
                        $row = mysqli_fetch_array($fetch);
                      ?>
                      ...
                      <?php } ?>
                       ...
                       <?php
                        $fetch = mysqli_query($conn, "SELECT * FROM questions JOIN category ON questions.quest_category_Id=category.cat_Id WHERE cat_name='English' LIMIT 13, 1");
                        if(mysqli_num_rows($fetch) > 0) {
                        $row = mysqli_fetch_array($fetch);
                      ?>
                      ...
                      <?php
                        $fetch = mysqli_query($conn, "SELECT * FROM questions JOIN category ON questions.quest_category_Id=category.cat_Id WHERE cat_name='English' LIMIT 14, 1");
                        if(mysqli_num_rows($fetch) > 0) {
                        $row = mysqli_fetch_array($fetch);
                      ?>
                      ...
                      <?php
                        $fetch = mysqli_query($conn, "SELECT * FROM questions JOIN category ON questions.quest_category_Id=category.cat_Id WHERE cat_name='English' LIMIT 15, 1");
                        if(mysqli_num_rows($fetch) > 0) {
                        $row = mysqli_fetch_array($fetch);
                      ?>
                      <input type="hidden" class="form-control" name="sixteen" value="<?php echo $row['quest_Id']; ?>">
                      <input type="hidden" class="form-control" name="correct_sixteen" value="<?php echo $row['correct_answer']; ?>">
                      <input type="hidden" id="ans_q16" class="form-control form-control-sm" name="ans_q16" value="NA">
                      <h5><b>16.</b> <?php echo $row['question']; ?></h5>
                      <input type="radio" name="q16" value="<?php echo $row['choice_one']; ?>" id="q61" onclick="sixteenth();"> 
                      <label style="font-weight: normal;" for="q61"><?php echo $row['choice_one']; ?></label>
                      <br>
                      <input type="radio" name="q16" value="<?php echo $row['choice_two']; ?>" id="q62" onclick="sixteenth();"> 
                      <label style="font-weight: normal;" for="q62"><?php echo $row['choice_two']; ?></label>
                      <br>
                      <input type="radio" name="q16" value="<?php echo $row['choice_three']; ?>" id="q63" onclick="sixteenth();"> 
                      <label style="font-weight: normal;" for="q63"><?php echo $row['choice_three']; ?></label>
                      <br>
                      <input type="radio" name="q16" value="<?php echo $row['choice_four']; ?>" id="q64" onclick="sixteenth();"> 
                      <label style="font-weight: normal;" for="q64"><?php echo $row['choice_four']; ?></label>
                      <br>
                      <br>
                      <script>
                        function sixteenth() {
                            var a = document.getElementById("q61").value;
                            var b = document.getElementById("q62").value;
                            var c = document.getElementById("q63").value;
                            var d = document.getElementById("q64").value;
                            var x = document.getElementById("ans_q16");

                                 if(document.getElementById('q61').checked) { x.value = a; }
                            else if(document.getElementById('q62').checked) { x.value = b; } 
                            else if(document.getElementById('q63').checked) { x.value = c; } 
                            else if(document.getElementById('q64').checked) { x.value = d; }
                            else { x.value = "NA"; }
                        }
                      </script>
                      <?php } ?>
                       ...
                       <?php
                        $fetch = mysqli_query($conn, "SELECT * FROM questions JOIN category ON questions.quest_category_Id=category.cat_Id WHERE cat_name='English' LIMIT 16, 1");
                        if(mysqli_num_rows($fetch) > 0) {
                        $row = mysqli_fetch_array($fetch);
                      ?>
                      <input type="hidden" class="form-control" name="seventeen" value="<?php echo $row['quest_Id']; ?>">
                      <input type="hidden" class="form-control" name="correct_seventeen" value="<?php echo $row['correct_answer']; ?>">
                      <input type="hidden" id="ans_q17" class="form-control form-control-sm" name="ans_q17" value="NA">
                      <h5><b>17.</b> <?php echo $row['question']; ?></h5>
                      <input type="radio" name="q17" value="<?php echo $row['choice_one']; ?>" id="q65" onclick="seventeenth();"> 
                      <label style="font-weight: normal;" for="q65"><?php echo $row['choice_one']; ?></label>
                      <br>
                      <input type="radio" name="q17" value="<?php echo $row['choice_two']; ?>" id="q66" onclick="seventeenth();"> 
                      <label style="font-weight: normal;" for="q66"><?php echo $row['choice_two']; ?></label>
                      <br>
                      <input type="radio" name="q17" value="<?php echo $row['choice_three']; ?>" id="q67" onclick="seventeenth();"> 
                      <label style="font-weight: normal;" for="q67"><?php echo $row['choice_three']; ?></label>
                      <br>
                      <input type="radio" name="q17" value="<?php echo $row['choice_four']; ?>" id="q68" onclick="seventeenth();"> 
                      <label style="font-weight: normal;" for="q68"><?php echo $row['choice_four']; ?></label>
                      <br>
                      <br>
                      <script>
                        function seventeenth() {
                            var a = document.getElementById("q65").value;
                            var b = document.getElementById("q66").value;
                            var c = document.getElementById("q67").value;
                            var d = document.getElementById("q68").value;
                            var x = document.getElementById("ans_q17");

                                 if(document.getElementById('q65').checked) { x.value = a; }
                            else if(document.getElementById('q66').checked) { x.value = b; } 
                            else if(document.getElementById('q67').checked) { x.value = c; } 
                            else if(document.getElementById('q68').checked) { x.value = d; }
                            else { x.value = "NA"; }
                        }
                      </script>
                      <?php } ?>
                      ...
                      <?php
                        $fetch = mysqli_query($conn, "SELECT * FROM questions JOIN category ON questions.quest_category_Id=category.cat_Id WHERE cat_name='English' LIMIT 17, 1");
                        if(mysqli_num_rows($fetch) > 0) {
                        $row = mysqli_fetch_array($fetch);
                      ?>
                      <input type="hidden" class="form-control" name="eighteen" value="<?php echo $row['quest_Id']; ?>">
                      <input type="hidden" class="form-control" name="correct_eighteen" value="<?php echo $row['correct_answer']; ?>">
                      <input type="hidden" id="ans_q18" class="form-control form-control-sm" name="ans_q18" value="NA">
                      <h5><b>18.</b> <?php echo $row['question']; ?></h5>
                      <input type="radio" name="q18" value="<?php echo $row['choice_one']; ?>" id="q69" onclick="eighteenth();"> 
                      <label style="font-weight: normal;" for="q69"><?php echo $row['choice_one']; ?></label>
                      <br>
                      <input type="radio" name="q18" value="<?php echo $row['choice_two']; ?>" id="q70" onclick="eighteenth();"> 
                      <label style="font-weight: normal;" for="q70"><?php echo $row['choice_two']; ?></label>
                      <br>
                      <input type="radio" name="q18" value="<?php echo $row['choice_three']; ?>" id="q71" onclick="eighteenth();"> 
                      <label style="font-weight: normal;" for="q71"><?php echo $row['choice_three']; ?></label>
                      <br>
                      <input type="radio" name="q18" value="<?php echo $row['choice_four']; ?>" id="q72" onclick="eighteenth();"> 
                      <label style="font-weight: normal;" for="q72"><?php echo $row['choice_four']; ?></label>
                      <br>
                      <br>
                      <script>
                        function eighteenth() {
                            var a = document.getElementById("q69").value;
                            var b = document.getElementById("q70").value;
                            var c = document.getElementById("q71").value;
                            var d = document.getElementById("q72").value;
                            var x = document.getElementById("ans_q18");

                                 if(document.getElementById('q69').checked) { x.value = a; }
                            else if(document.getElementById('q70').checked) { x.value = b; } 
                            else if(document.getElementById('q71').checked) { x.value = c; } 
                            else if(document.getElementById('q72').checked) { x.value = d; }
                            else { x.value = "NA"; }
                        }
                      </script>
                      <?php } ?>
                      ...
                      <?php
                        $fetch = mysqli_query($conn, "SELECT * FROM questions JOIN category ON questions.quest_category_Id=category.cat_Id WHERE cat_name='English' LIMIT 18, 1");
                        if(mysqli_num_rows($fetch) > 0) {
                        $row = mysqli_fetch_array($fetch);
                      ?>
                      <input type="hidden" class="form-control" name="nineteen" value="<?php echo $row['quest_Id']; ?>">
                      <input type="hidden" class="form-control" name="correct_nineteen" value="<?php echo $row['correct_answer']; ?>">
                      <input type="hidden" id="ans_q19" class="form-control form-control-sm" name="ans_q19" value="NA">
                      <h5><b>19.</b> <?php echo $row['question']; ?></h5>
                      <input type="radio" name="q19" value="<?php echo $row['choice_one']; ?>" id="q73" onclick="nineteenth();"> 
                      <label style="font-weight: normal;" for="q73"><?php echo $row['choice_one']; ?></label>
                      <br>
                      <input type="radio" name="q19" value="<?php echo $row['choice_two']; ?>" id="q74" onclick="nineteenth();"> 
                      <label style="font-weight: normal;" for="q74"><?php echo $row['choice_two']; ?></label>
                      <br>
                      <input type="radio" name="q19" value="<?php echo $row['choice_three']; ?>" id="q75" onclick="nineteenth();"> 
                      <label style="font-weight: normal;" for="q75"><?php echo $row['choice_three']; ?></label>
                      <br>
                      <input type="radio" name="q19" value="<?php echo $row['choice_four']; ?>" id="q76" onclick="nineteenth();"> 
                      <label style="font-weight: normal;" for="q76"><?php echo $row['choice_four']; ?></label>
                      <br>
                      <br>
                      <script>
                        function nineteenth() {
                            var a = document.getElementById("q73").value;
                            var b = document.getElementById("q74").value;
                            var c = document.getElementById("q75").value;
                            var d = document.getElementById("q76").value;
                            var x = document.getElementById("ans_q19");

                                 if(document.getElementById('q73').checked) { x.value = a; }
                            else if(document.getElementById('q74').checked) { x.value = b; } 
                            else if(document.getElementById('q75').checked) { x.value = c; } 
                            else if(document.getElementById('q76').checked) { x.value = d; }
                            else { x.value = "NA"; }
                        }
                      </script>
                      <?php } ?>
                      ...
                      <?php
                        $fetch = mysqli_query($conn, "SELECT * FROM questions JOIN category ON questions.quest_category_Id=category.cat_Id WHERE cat_name='English' LIMIT 19, 1");
                        if(mysqli_num_rows($fetch) > 0) {
                        $row = mysqli_fetch_array($fetch);
                      ?>
                      <input type="hidden" class="form-control" name="twenty" value="<?php echo $row['quest_Id']; ?>">
                      <input type="hidden" class="form-control" name="correct_twenty" value="<?php echo $row['correct_answer']; ?>">
                      <input type="hidden" id="ans_q20" class="form-control form-control-sm" name="ans_q20" value="NA">
                      <h5><b>20.</b> <?php echo $row['question']; ?></h5>
                      <input type="radio" name="q20" value="<?php echo $row['choice_one']; ?>" id="q77" onclick="two_zero();"> 
                      <label style="font-weight: normal;" for="q77"><?php echo $row['choice_one']; ?></label>
                      <br>
                      <input type="radio" name="q20" value="<?php echo $row['choice_two']; ?>" id="q78" onclick="two_zero();"> 
                      <label style="font-weight: normal;" for="q78"><?php echo $row['choice_two']; ?></label>
                      <br>
                      <input type="radio" name="q20" value="<?php echo $row['choice_three']; ?>" id="q79" onclick="two_zero();"> 
                      <label style="font-weight: normal;" for="q79"><?php echo $row['choice_three']; ?></label>
                      <br>
                      <input type="radio" name="q20" value="<?php echo $row['choice_four']; ?>" id="q80" onclick="two_zero();"> 
                      <label style="font-weight: normal;" for="q80"><?php echo $row['choice_four']; ?></label>
                      <br>
                      <br>
                      <script>
                        function two_zero() {
                            var a = document.getElementById("q77").value;
                            var b = document.getElementById("q78").value;
                            var c = document.getElementById("q79").value;
                            var d = document.getElementById("q80").value;
                            var x = document.getElementById("ans_q20");

                                 if(document.getElementById('q77').checked) { x.value = a; }
                            else if(document.getElementById('q78').checked) { x.value = b; } 
                            else if(document.getElementById('q79').checked) { x.value = c; } 
                            else if(document.getElementById('q80').checked) { x.value = d; }
                            else { x.value = "NA"; }
                        }
                      </script>
                      <?php } ?>
