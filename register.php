<title>BCS Entrance Examination  | Register</title>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="password" class="form-control"  placeholder="Password" name="password" required id="password" minlength="8" maxlength="12">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="password" class="form-control" placeholder="Confirm password" name="cpassword" required id="cpassword" onkeyup="validate_password()" minlength="8" maxlength="12"> 
                        ...
                        <div class="col-12">
                          <hr>
                          <input type="checkbox" required> <a type="button" href="#" data-toggle="modal" data-target="#exampleModal" style="text-decoration: none;">Data Privacy Agreement</a>
                        </div>
                    </div>
                    <!-- END ROW -->
              </div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p style="text-align: justify;text-indent: 30px;">I understand that all the information provided will be utilized with strict confidentiality and will only be accessed by school administrators.</p>
      </div>
