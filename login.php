<title>BCS Entrance Examination  | Login</title>
                  ...
                  <div class="card-header text-center justify-content-center d-flex">
                    <div class="col-6 p-3">
                      ...
                      <a href="login.php" class="h1">
                        <img src="images/logo_final.png" alt="logo" class="img-fluid">
                      </a>
                    </div>
                  </div>
                <div class="card-body  bg-white">
                  ...
                  <form action="processes.php" method="post" id="quickForm">
                    ...
                    <div class="input-group mb-3">
                      <input type="password" class="form-control" placeholder="Password" id="password" name="password" minlength="8" required maxlength="12">
                      <div class="input-group-append">
                        <div class="input-group-text">
